...
{
    public class SimpsonGeneratorParameters: InitialParametersBase
    {
        private int _a;
        private int _b;
        public override List<Guid> AllowedGenerators => new List<Guid> { GeneratorsConstants.SIMPSON_GENERATOR };
